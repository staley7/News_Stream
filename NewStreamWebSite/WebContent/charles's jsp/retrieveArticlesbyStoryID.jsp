...
<body>
	...
	<%
		input = Integer.parseInt(request.getParameter("Story_ID"));
	Class.forName("com.mysql.jdbc.Driver");
	connection = DriverManager.getConnection(connectionURL, "root", "");
	statement = connection.prepareStatement("SELECT Article_ID, Story_ID, URL, Source, Date, Title, Article_Keywords, Category, Quotations FROM article WHERE Story_ID = ?");
