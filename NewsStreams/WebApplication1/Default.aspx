<%@ Page Title="News Streams" Language="C#"  AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication1._Default" %>
  ...
  <body>
	...
	<body background = "img/debut_dark_@2X.png">
        ...
        function connectDB() {
            {
                ...
                xmlhttp.open("GET", "connectDb.asp", true);
                xmlhttp.send();
            }
        }
    </script>
