...
statement = connection.prepareStatement("SELECT Article_ID, Story_ID, URL, Source, Date, Title, Article_Keywords, Category, Quotations FROM article WHERE Category = ?");
